...
namespace Aura
{
	...
	public class GameManager : Microsoft.Xna.Framework.DrawableGameComponent
	{
		...
		/// </summary>
		Parallax plainsParallax1Background;
		/// <summary>
		/// The second parallax background class.
		/// </summary>
		Parallax plainsParallax2Background;
		/// <summary>
		/// The third parallax background class.
		/// </summary>
		Parallax plainsParallax3Background;
		/// <summary>
		/// The first parallax texture.
		/// </summary>
		...
		/// The first parallax background class.
		/// </summary>
		Parallax forestParallax1Background;
		/// <summary>
		/// The second parallax background class.
		/// </summary>
		Parallax forestParallax2Background;
		/// <summary>
		/// The third parallax background class.
		/// </summary>
		Parallax forestParallax3Background;
		/// <summary>
		/// The first parallax texture.
		/// </summary>
		...
		/// The first parallax background class.
		/// </summary>
		Parallax caveParallax1Background;
		/// <summary>
		/// The second parallax background class.
		/// </summary>
		Parallax caveParallax2Background;
		/// <summary>
		/// The third parallax background class.
		/// </summary>
		Parallax caveParallax3Background;
		/// <summary>
		/// The first parallax texture.
		/// </summary>
		...
		/// The first parallax background class.
		/// </summary>
		Parallax villageParallax1Background;
		#endregion
		...
		public void SpawnBricks(int level)
		{
			...
			for (int x = 0; x < width; x++)
			{
				for (int y = 0; y < height; y++)
				{
					...
					{
						platformList.Add(new Tile(plainsPlatformTexture, new Vector2(x * 25, y * 25), Tile.TileCollisions.Impassable, platformList, (int)brickspawn[x, y], Color.White));
					}
					...
					if (brickspawn[x, y] == 78)
					{
						...
						camera.Position = new Vector2(player.Position.X + 200f, player.Position.Y);
					}
			...
			foreach (Tile pm in platformList)
			{
				platformRectangles.Add(new Rectangle((int)pm.Position.X, (int)pm.Position.Y + 3, 25, 22));
			}
		}
	}
}