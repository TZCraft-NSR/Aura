...
namespace WrathOfJohn
{
	...
	public class MenuManager : Microsoft.Xna.Framework.DrawableGameComponent
	{
        ...
        protected override void LoadContent()
        {
            ...
            exitButton = new Button(new Vector2((myGame.windowSize.X - 170) / 2, 366), myGame.segoeUI, 1f, Color.Black, "Exit", Color.White, animationSpriteList);
            playButton = new Button(new Vector2((myGame.windowSize.X - 170) / 2, 190), myGame.segoeUI, 1f, Color.Black, "Play", Color.White, animationSpriteList);
