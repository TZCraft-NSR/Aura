...
namespace VoidEngine
{
    ...
    public class Sprite
    {
        ...
        {
            spriteBatch.Draw(CurrentAnimation.texture, this.Position, new Rectangle((int)RotationCenter.X + CurrentAnimation.startPosition.X + (CurrentFrame.X * CurrentAnimation.frameSize.X), (int)RotationCenter.Y + CurrentAnimation.startPosition.Y + (CurrentFrame.Y * CurrentAnimation.frameSize.Y), CurrentAnimation.frameSize.X, CurrentAnimation.frameSize.Y), _Color, Rotation, RotationCenter, 1f, isFlipped, 0);
        }
